...
def generate_data_js():
    """
    Combines SJR and CORE rankings into the plugin's data.js file.
    Reads from sjr_rankings.json and core_rankings.json (generated by extract scripts)
    ...
    try:
        ...
        print("  ERROR: core_rankings.json not found. Run analyze_full_core.py first.")
        return
